"""
Django settings for wheele project.
...
SECRET_KEY = 'django-insecure-9dd!szl^+^rvxuoljgc%!=#u51wj5^&g%u%2#z^!_4(_acppdj'
...
WSGI_APPLICATION = 'wheele.wsgi.application'
...
AUTH_USER_MODEL = 'accountConfig.User'
